                        ...
                        if (isset($data['drama'])) {
                            foreach ($data['drama'] as $x) { ?>
                                ...
                                <tr>
                                    ...
                                    <td><?= $x->title ?></td>
                                    <td><?= substr($x->description, 0, 100) ?></td>
                                    <td>
                                        <div class="btns">
                                            <form method="post" id="delete">
                                                <input type="hidden" name="id" value="<?= $x->id ?>">
                                                <input type="hidden" name="delete" value="delete">
                                                <button class="btn-delete" id="del" type="submit">Delete</button>
                                            </form>

                                            <form method="post" id="update">
                                                <input type="hidden" name="id" value="<?= $x->id ?>">
                                                <input type="hidden" name="update" value="update">
                                                <button class="btn-update" id="upd" type="submit">Update</button>
                                            </form>
                                        </div>
                                    </td>
                                </tr>
